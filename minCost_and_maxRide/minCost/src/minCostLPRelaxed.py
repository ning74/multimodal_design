...
def createConstrs(m, node_list, od_pairs, ori_nodes, dest_nodes, lines, lines_edge, demand_dic, cap_lines, list_f_sluv, list_y_slv, list_w_slv, list_z_stv, list_z,\
				  f, y, w, z, q, x, Y, bus_nodes, st_dict, ls_dict, svl_dict, z_uvs_dict, y_uvl_dict, all_lines_edge, dict_edge_lines, demand_perc):
	...
	return C4_toRemove, C5_toRemove, C6_toRemove
...
def getResult(node_list, od_pairs, ori_nodes, dest_nodes, lines, lines_edge, cost_edges, cost_lines, demand_dic, cap_lines, list_f_sluv,\
	       list_y_slv, list_w_slv, list_z_stv, list_z, bus_nodes, st_dict, ls_dict, svl_dict, z_uvs_dict, y_uvl_dict, all_lines_edge, dict_edge_lines, demand_perc):
	...
	# create constraints 
	C4_toRemove, C5_toRemove, C6_toRemove = createConstrs(m, node_list, od_pairs, ori_nodes, dest_nodes, lines, lines_edge, demand_dic, cap_lines, list_f_sluv, list_y_slv, list_w_slv, list_z_stv, list_z,\
				  f, y, w, z, q, x, Y, bus_nodes, st_dict, ls_dict, svl_dict, z_uvs_dict, y_uvl_dict, all_lines_edge, dict_edge_lines, demand_perc)
	...
	gurobi_time = time.process_time() - start_time



	return m, m.ObjVal, C4_toRemove, C5_toRemove, C6_toRemove, f, y, w, z, q, x, Y
...
def newLineLP(m, C4_toRemove, C5_toRemove, C6_toRemove, cap, od_pairs, node_list, new_lines, lines_edge, ori_nodes, cost_edges, new_line, new_cost_lines, new_cap_lines, new_dict_stlInd_uInd, list_f_sluv, list_y_slv, list_w_slv, list_z_stv, list_z\
	...
	w_new = m.addVars(list_w_slv_new, lb = 0, ub = float('inf'), vtype = GRB.CONTINUOUS, name = 'var_2')
	w.update(w_new)
	...
	return m, C4_toRemove, C5_toRemove, C6_toRemove, f, y, w, z, q, x, Y, lines_edge, list_f_sluv, list_y_slv, list_w_slv, list_z_stv, list_z\
